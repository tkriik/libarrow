...
/* Matrix constructors. */
mat2f	mat2f_make(vec2f, vec2f);
mat2d	mat2d_make(vec2d, vec2d);
mat3f	mat3f_make(vec3f, vec3f, vec3f);
mat3d	mat3d_make(vec3d, vec3d, vec3d);
mat4f	mat4f_make(vec4f, vec4f, vec4f, vec4f);
mat4d	mat4d_make(vec4d, vec4d, vec4d, vec4d);
...
mat3f	mat3f_rotation(float);	// TODO
mat3d	mat3d_rotation(double);	// TODO

/* Matrix and vector product functions. */
mat2f	mat2f_mul_mat(mat2f, mat2f);
mat2d	mat2d_mul_mat(mat2d, mat2d);
mat3f	mat3f_mul_mat(mat3f, mat3f);
mat3d	mat3d_mul_mat(mat3d, mat3d);
mat4f	mat4f_mul_mat(mat4f, mat4f);
mat4d	mat4d_mul_mat(mat4d, mat4d);
